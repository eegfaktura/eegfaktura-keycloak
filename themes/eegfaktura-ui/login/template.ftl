...
<div class="vfeeg-container">
    <div class="vfeeg-sidebar">
        <p class="login-text"><strong>Login</strong></p>
        <p class="description-text">${kcSanitize(client.description!"")?no_esc}</p>
    </div>
    <div class="${properties.kcLogin!}" style="background-color: #EAE7D9; width: 70%;">
